...
public class MainActivity extends Activity implements TestFragment0.OnFragmentInteractionListener, TestFragment1.OnFragmentInteractionListener, TestFragment2.OnFragmentInteractionListener, TestFragment3.OnFragmentInteractionListener, TestFragment4.OnFragmentInteractionListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getActionBar().show();
        getActionBar().setBackgroundDrawable(new ColorDrawable(Color.parseColor("#7D0900")));
        ...
        navMenuTitles = getResources().getStringArray(R.array.list_items);
    ...
    private void displayView(int position) {
        ...
        switch (position) {
            ...
            case 5:
                ...
                break;
            case 6:
                fragment = new TestFragment6();
                break;
            case 7:
                fragment = new TestFragment7();
                break;
            case 8:
                fragment = new TestFragment8();
                break;
            case 9:
