...
public class NavigationAdapter extends ArrayAdapter<NavigationItem>{
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        itemView.setTextColor(navigationItem.getIsSelected() ? NavigationListView.mSelectedColour : mContext.getResources().getColor(R.color.background));
    ...
    private Drawable getColouredDrawable(Drawable _drawable, boolean _isSelected){
        int iColor = _isSelected ? NavigationListView.mSelectedColour : mContext.getResources().getColor(R.color.background);
