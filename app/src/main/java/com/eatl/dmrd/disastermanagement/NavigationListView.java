...
public class NavigationListView extends ListView {
    ...
    private void init(AttributeSet _attrs){
        ...
        mSelectedColour = getResources().getColor(R.color.red);
        ...
        setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                ImageView selected = (ImageView) view.findViewById(R.id.icon);
                selected.setImageResource(R.drawable.ic_add_list_white);
