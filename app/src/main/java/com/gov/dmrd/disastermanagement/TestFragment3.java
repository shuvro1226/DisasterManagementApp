...
public class TestFragment3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        for (int i = 0; i < name.length; i++){
            ...
            tv5.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 14);
            ll.addView(tv5);
